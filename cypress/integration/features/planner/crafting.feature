Feature: Operator Planner - crafting
  ...
  Rule: Items being crafted and their ingredients are shown if there is a goal that needs them
    Background:
      Given I have added a goal to my planner
  ...
  Rule: Items to be crafted and their ingredients update in response to changes
    Background:
      Given I have added a goal to my planner
      And I have marked some items to be crafted
